    ...
    <>
      <div className="space-y-1.5">
        {entries.map(entry => (
          <div
            key={entry.id}
            className="bg-white rounded-xl px-3.5 py-2.5 shadow-sm border border-slate-100 flex items-center gap-3 active:scale-[0.99] transition-transform cursor-pointer"
